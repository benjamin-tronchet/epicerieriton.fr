                ...
                <div class="x_panel">
                    <div class="x_content">
                       <blockquote>
                        ...
                        <p>
                            Pour pouvoir modifier les produits du moment, cliquez sur le lien <strong><a href="index.php?page=actualites"> <i class="fa fa-file-text"></i> En ce moment</a></strong> dans le menu situé a gauche de l'écran.
                            <br>
                            Une fois votre contenu modifié, cliquez sur <span class="btn btn-success btn-xs record">Enregister</span> - en haut, à droite - pour que la modification soit effective sur votre site.
                            <br/><br/>
                            <b>ATTENTION :</b> tous les champs sont obligatoires lors de la modification du contenu.
                            <br><br>
                        </p>
                        <br>
                        <h2>Infos utiles</h2>
