...
<!-- start content  -->
<div class="row offre">
    <form enctype="multipart/form-data" id="enregistrer-offre" action="index.php?page=actualite" method="post" class="col-xs-12">
...
<!--
                        <div class="row">
                            <div class="col-sm-12">
                                <strong><i class="fa fa-warning"></i> La date sera automatiquement mise à jour lors de l'enregistrement.</strong>
                                <br><br>
                            </div>
                        </div>
-->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 uploadfile">
                                            <label for="fileToUpload" class="label-file btn btn-info">Choisir une <?=($actualite_img) ? "autre" : "" ?> image</label>
